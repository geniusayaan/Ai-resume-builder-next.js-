...
{resumes?.map((resume,id)=>(
  ...
  <div  className="border w-[80px] h-[80px] md:w-[140px] lg:w-[180px] xl:w-[200px] sm:h-[120px] sm:w-[120px] md:h-[140px] lg:h-[180px] xl:h-[200px] p-2 text-2xl flex flex-col items-center border-black  dark:border-white"></div>
